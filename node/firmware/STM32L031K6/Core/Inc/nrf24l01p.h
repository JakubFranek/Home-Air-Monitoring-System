...
typedef int8_t (*nrf24l01p_spi_tx_t)(uint8_t register_address);
typedef int8_t (*nrf24l01p_spi_rx_t)(uint8_t *register_value);
typedef int8_t (*nrf24l01p_spi_tx_rx_t)(uint8_t register_address, uint8_t *register_value);
